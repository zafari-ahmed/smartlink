...
/**
 * This is the model class for table "customer_previews".
 *
 * The followings are the available columns in table 'customer_previews':
 * @property integer $id
 ...
 */
class CustomerPreviews extends CActiveRecord
{
	/**
	 ...
	 * @return CustomerPreviews the static model class
	 */
