...
class CustomerPlots extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('customer_id, plot_id, createdOn, status, updatedBy, is_agent, agent_name, agent_cnic, agent_percentage, is_special, blocked, charge_id, phase_id', 'required'),
			array('customer_id, plot_id, status, is_agent, agent_percentage, agent_id, is_special, blocked, user_id, monthlyMonths, charge_id, phase_id, is_open', 'numerical', 'integerOnly'=>true),
			array('updatedBy, agent_name, agent_cnic, total_penalty', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, customer_id, plot_id, createdOn, status, updatedBy, is_agent, agent_name, agent_cnic, agent_percentage, agent_id, is_special, blocked, user_id, monthlyMonths, charge_id, total_penalty, phase_id, is_open', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'customerPlotTransactionSum' => array(self::STAT, 'CustomerPlotTransactions', 'plot_id', 'select'=>'SUM(amount)'),
