 ...
 * @property CustomerPlotTransfers[] $customerPlotTransfers
 */
class Customers extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'customerPlotTransactions' => array(self::HAS_MANY, 'CustomerPlotTransactions', 'customer_id'),
			'customerPlots' => array(self::HAS_MANY, 'CustomerPlots', 'customer_id'),
		);
	}
