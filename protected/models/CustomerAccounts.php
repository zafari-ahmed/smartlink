...
class CustomerAccounts extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('account_balance', 'numerical'),
			array('currency_type, payment_mode, payment_type', 'length', 'max'=>255),
			array('customer_id', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, customer_id, currency_type, payment_mode, payment_type, account_balance', 'safe', 'on'=>'search'),
		);
	}
