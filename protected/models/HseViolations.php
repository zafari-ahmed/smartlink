...
/**
 * This is the model class for table "hse_violations".
 *
 * The followings are the available columns in table 'hse_violations':
 * @property string $id
 ...
 */
class HseViolations extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('team_id, violation_category_id', 'required'),
			array('created_at, updated_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, team_id, violation_category_id, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return HseViolations the static model class
	 */
