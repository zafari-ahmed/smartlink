...
/**
 * This is the model class for table "super_users".
 *
 * The followings are the available columns in table 'super_users':
 * @property integer $id
 ...
 */
class SuperUsers extends CActiveRecord
{
	/**
	 ...
	 * @return SuperUsers the static model class
	 */
