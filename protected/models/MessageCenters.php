...
/**
 * This is the model class for table "message_centers".
 *
 * The followings are the available columns in table 'message_centers':
 * @property string $id
 ...
 */
class MessageCenters extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('sent_by, sent_to, message, send_date, receiving_date, response_date, reply, created_at, updated_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, sent_by, sent_to, message, send_date, receiving_date, response_date, reply, is_read, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return MessageCenters the static model class
	 */
