...
<body>
    <div class="main container">
        <div class="container content" >
            <?php if($duplicate==1){?>
            <div style="text-align: center;border: 2px solid #000;border-radius: 5px;width: 90px;margin-left: 50%;position: absolute;top: 5%;">Duplicate</div>
            <?php } ?>
            <br>
            <br>
    ...
    <div class="mainYY container">
            <div class="container content" >
                <div class="center"><h6>TERMS AND CONDITIONS ALLOCATION LETTER</h6></div>
                <p>
                ...
                <table style="width: 100%;" border="0">
                    <tr>
                        <td class="terms" style="text-align: left; width: 50%;padding-bottom: 10px;font-weight: bold;font-size: 13px;">
                            Date : <span class="terms"></span><span class="terms"></span>
                        </td>
                        <td class="terms" style="text-align: center;font-weight: bold; width: 50%;padding-bottom: 10px;font-weight: bold;font-size: 13px;line-height: 7px;">
                            <br>
                            <br>
                            <br>
