...
<body>
    <div class="main container hide">
        <div class="container content" >
            <div style="position: absolute;top: 21%;left: 20%;"><b><?php echo $this->getBookingRegNo($customerPlot->id)?></b></div>
            <div style="position: absolute;top: 21%;left: 75%;"><b><?php echo date('d M, o')?></b></div>
    ...
    <div class="container">
        ...
        <div class="mainYY container">
            <div class="container content" >
                <div class="center"><h5>TERMS AND CONDITIONS</h5></div>
                <p>
