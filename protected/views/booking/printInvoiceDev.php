    ...
    <div style="width:700px;height:842px;background:#fff;margin:0 auto;font-family:Arial, Helvetica, sans-serif;font-size:16px;;margin-top: 1%;padding-top: 15px;">
		<div style="overflow:hidden;">
			...
			<div style="width:70%;float:left;">
                ...
                <h1 style="border-bottom:solid 2px #000;padding:0px 0;margin:0;font-weight:bold;font-size: 25px;text-align: center;">Development Receipt</h1>
			</div>
			<div style="width:15%;float:left;">
        ...
        <div style="overflow:hidden;margin:05px 0;">
            <div style="width:120px;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:left;margin-right:10px;">
                ...
                <input type="text" placeholder="" value="<?php echo @$transaction[0]->transaction_type?>" style="border:0;border-bottom:solid 1px #000;width:35px;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:right;outline:0;text-align: center;" />
            </div>
        ...
        <div style="border:solid 2px #000;margin:10px 0;border-radius:10px;padding-bottom:5px;height: 31%">
            ...
            <div style="border-bottom:dashed 1px #000;padding:3px 10px;overflow:hidden;">
                ...
                <div style="width:250px;float:left;font-size:10px;font-family:Arial, Helvetica, sans-serif;margin-right:10px;">Development Charges</div>
                <div style="width:60px;float:left;font-size:10px;font-family:Arial, Helvetica, sans-serif;margin-right:10px;"><?php echo ($transact->monthlyDate!='')?$transact->monthlyDate:''?></div>
