    ...
    <div style="width:700px;height:842px;background:#fff;margin:0 auto;font-family:Arial, Helvetica, sans-serif;font-size:16px;;margin-top: 1%;padding-top: 15px;">
		<div style="overflow:hidden;">
			...
			<div style="width:70%;float:left;text-align: center;">
                <span style="text-align: center;border: 2px solid;border-radius: 5px;padding: 5px;position: relative;top: 10px;">Demand Bill</span>
        ...
        <div style="border:solid 2px #000;margin:10px 0;border-radius:10px;padding-bottom:5px;height: 51%">
            ...
            <div style="border-bottom:dashed 1px #000;padding:3px 10px;overflow:hidden;">
                ...
                <div style="width:150px;float:left;font-size:10px;font-family:Arial, Helvetica, sans-serif;margin-right:2%;font-weight: bold;"><?php echo ucfirst(@$transact->plotPaymentMode->mode)?></div>
        ...
        <div style="margin:-05px 0 0;">
            <div style="padding: 3px 15px;overflow: hidden;margin-top: -7%;position: absolute;z-index: 9999999999;">
                ...
                <?php if($is_monthly==1){?>
                    <div style="width:450px;font-size:12px;font-family:Arial, Helvetica, sans-serif;margin-right:10px; font-weight: bold">*&nbsp;<?php echo $this->getPlotLedgerDetailSingle(@$booking->id,'monthly')?></div>
                <?php }?>
            </div>
