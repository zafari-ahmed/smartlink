...
<div class="col-lg-12 infoBox hide" style="margin-top: -5%!important;">
...
<?php if($modes->mode=='yearly'){
    ...
    <div class="col-lg-12 infoBox">
        <p style="text-align: center;"><b><?php echo Yii::app()->name ?> - Booking Ledger (Transactions) </b><br/><b>Printing Date: <?php echo date('d M,Y')?></b></p>
        <div class="col-lg-4 infoDiv">
            <p style="text-align: center;">&nbsp;</p>
            <div class="row">
                <div class="col-lg-12"><b><PRE class="preClass">CUSTOMER INFO.</PRE></b></div>
