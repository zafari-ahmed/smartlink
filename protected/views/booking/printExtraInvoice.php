    ...
    <div style="width:700px;height:842px;background:#fff;margin:0 auto;font-family:Arial, Helvetica, sans-serif;font-size:16px;;margin-top: 1%;padding-top: 15px;">
        ...
        <div style="overflow:hidden;margin:05px 0;">
            ...
            <div style="width:155px;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:left;margin-right:10px;">
                ...
                <input type="text" placeholder="Date" value="<?php echo date('d-M-o',strtotime(@$transaction[0]->createdOn))?>" style="border:0;width:90px;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:right;outline:0;" />
            </div>
        ...
        <div style="overflow:hidden;margin:05px 0;">
            <div style="width:100%;font-family:Arial, Helvetica, sans-serif;font-size:12px;">
            	<label style="width:300px;float:left;font-weight: bold;">Received with thanks from Mr./Mrs./Miss.</label>
        ...
        <div style="overflow:hidden;margin:05px 0;">
            ...
            <div style="width:165px;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:left;margin-right:10px;">
            ...
            <div style="width:160px;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:left;">
        ...
        <div style="border:solid 2px #000;margin:10px 0;border-radius:10px;padding-bottom:5px;height: 51%">
            ...
            <?php $is_monthly = 0;$total = 0; $lastMonthlyy = @$lastMonthly; if($transaction) { foreach($transaction as $index=>$transact): $total = $total + $transact->amount;?>
            ...
            <div style="border-bottom:dashed 1px #000;padding:3px 10px;overflow:hidden;">
                ...
                <div style="width:150px;float:left;font-size:10px;font-family:Arial, Helvetica, sans-serif;margin-right:2%;font-weight: bold;"><?php echo ucfirst(@$transact->plot_payment_mode)?></div>
        ...
        <div style="margin:-05px 0 0;">
            ...
            <div style="width:100%;font-family:Arial, Helvetica, sans-serif;font-size:10px;float:left;margin-right:10px;">
                ...
                <input type="text" value="<?php echo $this->getIndianCurrency($total)?>" placeholder="Price" style="border:0;width:90%;font-family:Arial, Helvetica, sans-serif;font-size:10px;outline:0;text-transform: uppercase;    font-weight: bold;" />
            </div>
        </div>
    ...
    <div style="width:700px;height:842px;background:#fff;margin:0 auto;font-family:Arial, Helvetica, sans-serif;font-size:16px;margin-top: 1%;padding-top: 15px;">
        <div style="overflow:hidden;">
            ...
            <div style="width:70%;float:left;">
                <h1 style="margin:10px 0 0;text-align: center;    font-size: 36px;">Kainat City</h1>
                 <h1 style="border-bottom:solid 2px #000;padding:0px 0;margin:0;font-weight:bold;font-size: 25px;text-align: center;"><?php echo ucfirst($type)?> Receipt</h1>
            </div>
            <div style="width:15%;float:left;">
        ...
        <div style="overflow:hidden;margin:05px 0;">
            ...
            <div style="width:170px;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:left;margin-right:10px;">
                <label style="width:30px;float:left;font-weight: bold;">Bank</label>
                <input type="text" value="<?php echo (@$transaction[0]->transaction_type != 'cash')?@$transaction[0]->bank:''?>" style="border:0;border-bottom:solid 1px #000;width:100px;font-family:Arial, Helvetica, sans-serif;font-size:12px;outline:0;margin-left: 5px" />
            </div>
            <div style="width:250px;font-family:Arial, Helvetica, sans-serif;font-size:11px;float:left;margin-right:10px;">
                <label style="width:110px;float:left;font-weight: bold;">Pay Order/Cheque #:</label>
                <input type="text" value="<?php echo @$transaction[0]->reference_number?>" style="border:0;width:80px;font-family:Arial, Helvetica, sans-serif;font-size:12px;outline:0;" />
            </div>
        ...
        <div style="border:solid 2px #000;margin:10px 0;border-radius:10px;padding-bottom:5px;height: 31%">
            <div style="border-bottom:solid 2px #000;margin-bottom:5px;padding:10px;overflow:hidden;font-weight:bold">
                <div style="width:40px;float:left;font-size:11px;font-family:Arial, Helvetica, sans-serif;margin-right:10px;">S#.</div>
                <div style="width:250px;float:left;font-size:11px;font-family:Arial, Helvetica, sans-serif;margin-right:10px;">Mode of Payment</div>
                <div style="width:80px;float:left;font-size:11px;font-family:Arial, Helvetica, sans-serif;margin-right:10px;">Month</div>
                <div style="width:80px;float:left;font-size:11px;font-family:Arial, Helvetica, sans-serif;margin-right:10px;">&nbsp;</div>
                <div style="width:100px;float:left;font-size:11px;font-family:Arial, Helvetica, sans-serif;">Received Amount</div>
            </div>
            
            <?php $total = 0; $lastMonthlyy = @$lastMonthly; if($transaction) { foreach($transaction as $index=>$transact): $total = $total + $transact->amount;?>
            ...
            <div style="border-bottom:dashed 1px #000;padding:3px 10px;overflow:hidden;">
                ...
                <div style="width:250px;float:left;font-size:10px;font-family:Arial, Helvetica, sans-serif;margin-right:10px;"><?php echo ucfirst($type)?> Charges</div>
                <!-- <div style="width:60px;float:left;font-size:10px;font-family:Arial, Helvetica, sans-serif;margin-right:10px;"><?php //echo ($transact->monthlyDate!='')?date('M, Y',strtotime($transact->monthlyDate)):''?></div> -->
                <div style="width:60px;float:left;font-size:10px;font-family:Arial, Helvetica, sans-serif;margin-right:10px;"><?php echo @$transact->monthlyDate?></div>
                <div style="width:80px;float:left;font-size:10px;text-align:right;font-family:Arial, Helvetica, sans-serif;margin-right:10px;">&nbsp;</div>
