...
<body style="margin:0;font-family:Arial, Helvetica, sans-serif;font-size:14px; margin-top: 10px;">
    <div style="width:700px;height:842px;background:#fff;margin:0 auto;font-family:Arial, Helvetica, sans-serif;font-size:16px;;margin-top: 1%;padding-top: 15px;">
        <img src="/kainat/images/cancelledInvoice.png" style="    position: absolute;z-index: 999;width: 80%;margin-left: 2%;margin-top: 5%;opacity: 0.2;">
        ...
        <div style="overflow:hidden;margin:05px 0;">
            ...
            <div style="width:140px;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:left;">
                ...
                <input type="text" placeholder="Rec by" value="<?php echo @$transaction[0]->createdBy?>" style="border:0;width:80px;font-family:Arial, Helvetica, sans-serif;font-size:11px;float:left;outline:0;border-bottom: solid 1px #000;font-weight: bold;" />
            </div>
        </div>
        ...
        <div style="overflow:hidden;margin:05px 0;">
            <div style="width:450px;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:left;margin-right:10px;">
                ...
                <input type="text" placeholder="Name" value="<?php echo ucwords(@$booking->customer->father_husband_name)?>" style="border:0;border-bottom:solid 1px #000;width:300px;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:left;outline:0;" />
            </div>
            <?php /*?>
        ...
        <div style="margin:-05px 0 0;">
            <div style="padding: 3px 15px;overflow: hidden;margin-top: -7%;position: absolute;z-index: 9999999999;">
                ...
                <?php if($is_monthly==1){?>
                    <div style="width:450px;font-size:12px;font-family:Arial, Helvetica, sans-serif;margin-right:10px; font-weight: bold">*Monthly Installment:&nbsp;<?php echo $this->getPlotLedgerDetailSingle(@$booking->id,'monthly')?></div>
                <?php }?>
            </div>
        ...
        <div style="margin:5px 0 0;">
            ...
            <div style="width:350px;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:right;">
                ...
                <div style="width:100%;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:left;margin-top:5px;">
                    ...
                    <input type="text" value="<?php echo date('d/m/Y',strtotime($transaction[0]->createdOn))//date('d/m/o')?>" placeholder="Date" style="border:0;width:250px;text-align:center;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:right;outline:0;" />
                </div>
                <div style="width:100%;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:left;margin-top:5px;">
                    <label style="width:80px;float:left;">Posted By:</label>
                    <input type="text" value="<?php echo @$transaction[0]->createdBy?>" placeholder="Date" style="border:0;width:250px;text-align:center;font-family:Arial, Helvetica, sans-serif;font-size:12px;float:right;outline:0;" />
                </div>
                <?php if(isset($transact->plot_payment_mode_id)){?> 
                    <?php if(@$transaction[0]->reason){?>
                        <p style="color:#000;font-size:12px;margin:0;font-weight:bold;padding-top: 30%;">*Reason:   <?php echo @$transaction[0]->reason?></p>
                    <?php }?>
                <?php }?>
            </div>
        </div>
